...
A few weeks ago, i got a free tier fedora 26 instance on _AWS._ I had to use this for testing other applications that i was working on. Also, AWS doesn't allow(atleast for my instance) _HTTPS_ connections for ports other than 443. I wanted to use ssl and that too for more than one application and thus decided using _nginx_ as reverse proxy.
